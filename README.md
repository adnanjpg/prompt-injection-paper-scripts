...
- Reads prompts from `inputs/prompts.xlsx`
...
The input file `inputs/prompts.xlsx` should contain:
...
3. **Prepare input file:**
   - Ensure `inputs/prompts.xlsx` exists with the correct format
...
│   ├── inputs/
│   │   └── prompts.xlsx   # Input prompts (80 prompts, 8 categories)
│   └── outputs/
